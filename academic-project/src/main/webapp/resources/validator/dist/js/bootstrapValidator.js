...
;(function($) {
    ...
    $.fn.bootstrapValidator.validators.stringLength = {
        ...
        validate: function(validator, $field, options) {
            ...
            var min        = $.isNumeric(options.min) ? options.min : validator.getDynamicOption($field, options.min),
                max        = $.isNumeric(options.max) ? options.max : validator.getDynamicOption($field, options.max),
                fix        = $.isNumeric(options.fix) ? options.fix : validator.getDynamicOption($field, options.fix)
            ...
            if ((min && length < parseInt(min, 10)) || (max && length > parseInt(max, 10)) || (fix && length != parseInt(fix, 10))) {
                isValid = false;
            }
            ...
            switch (true) {
                ...
                case (!!fix):
                	message = $.fn.bootstrapValidator.helpers.format(options.message || $.fn.bootstrapValidator.i18n.stringLength.fix, parseInt(fix, 10));
